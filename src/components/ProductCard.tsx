...
const ProductCard: FunctionComponent = () => {
  ...
  return (
    ...
    >
      <div
      className={`w-[285px] flex flex-col items-start justify-start pt-0 px-0 pb-[30px] box-border relative gap-[16px] text-left text-base text-color-white font-poppins `}

    >
      <textarea
        className="[border:none] bg-color-light-bg h-[145px] w-full [outline:none] absolute !m-[0] right-[0px] bottom-[0px] left-[0px]"
        rows={7}
        cols={14}
      />
      ...
      <div className="self-stretch h-[446px] relative hidden z-[3] text-color-primary">
        ...
        <div className="absolute top-[175px] left-[calc(50%_-_126.5px)] flex flex-col items-center justify-center gap-[24px]">
          ...
          <div className="self-stretch flex flex-row items-center justify-start gap-[20px] text-color-white">
            ...
            <div className="h-6 flex flex-row items-center justify-center gap-[2px]">
              <img className="h-4 w-4 relative" alt="" src="/heart.svg" />
              <div className="self-stretch relative leading-[150%] font-semibold">
                Like
              </div>
            </div>
