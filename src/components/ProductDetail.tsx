...
const ProductDetail: FunctionComponent<GroupComponent3Type> = ({
  className = "",
}) => {
  ...
  return (
    <div
      className={`self-stretch flex flex-row items-start justify-start pt-[35px] px-[99px] pb-[55px] box-border gap-[82px] max-w-full z-[2] mt-[-3px] text-left text-smi text-black font-poppins lg:flex-wrap lg:gap-[41px] lg:pl-[49px] lg:pr-[49px] lg:box-border mq450:pb-[23px] mq450:box-border mq750:gap-[20px] mq750:pl-6 mq750:pr-6 mq750:box-border mq1050:pb-9 mq1050:box-border ${className}`}
    >
        ...
        <div className="w-[582px] flex flex-col items-start justify-start gap-[2px] max-w-full">
          ...
          <div className="flex flex-row items-start justify-start pt-0 px-px pb-4">
            <div className="flex flex-row items-start justify-start gap-[16px]">
              <div className="rounded-8xs bg-primary flex flex-row items-start justify-start py-[5px] px-3 z-[1] text-color-white">
                <div className="h-[30px] w-[30px] relative rounded-8xs bg-primary hidden" />
                <div className="relative inline-block min-w-[6px] z-[1]">L</div>
              </div>
              <div className="rounded-8xs bg-linen-200 flex flex-row items-start justify-start py-[5px] px-2 z-[1]">
                <div className="h-[30px] w-[30px] relative rounded-8xs bg-linen-200 hidden" />
                <div className="relative inline-block min-w-[14px] z-[1]">
                  XL
                </div>
              </div>
              <div className="rounded-8xs bg-linen-200 flex flex-row items-start justify-start py-[5px] px-[7px] z-[1]">
                <div className="h-[30px] w-[30px] relative rounded-8xs bg-linen-200 hidden" />
          ...
          <div className="self-stretch flex flex-row items-start justify-start py-0 pr-0 pl-px box-border max-w-full text-base">
            <div className="flex-1 flex flex-col items-start justify-start gap-[32px] max-w-full mq750:gap-[16px]">
              <div className="flex flex-row items-start justify-start gap-[16px]">
                ...
                <div className="h-[30px] w-[30px] relative rounded-31xl bg-primary z-[1]" />
              </div>
              <div className="self-stretch flex flex-row items-start justify-start gap-[10px] mq750:flex-wrap">
                <div className="w-[131px] flex flex-col items-start justify-start py-0 pr-2 pl-0 box-border">
                  <div className="self-stretch rounded-3xs bg-color-white overflow-x-auto flex flex-row items-start justify-between py-[18px] pr-[13px] pl-3.5 gap-[20px] z-[1] border-[1px] border-solid border-darkgray">
                    <div className="h-16 w-[123px] relative rounded-3xs bg-color-white box-border shrink-0 hidden border-[1px] border-solid border-darkgray" />
                    <div className="relative inline-block min-w-[9px] whitespace-nowrap z-[1]">
                      -
                    </div>
                    <div className="relative font-medium inline-block min-w-[6px] whitespace-nowrap z-[1]">
                      1
                    </div>
                    <div className="relative inline-block min-w-[11px] whitespace-nowrap z-[1]">
                      +
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1 rounded-mini box-border flex flex-row items-start justify-start pt-[13px] pb-3 pr-[45px] pl-[46px] gap-[10px] min-w-[140px] z-[1] text-4xl border-[1px] border-solid border-black">
                  <div className="h-16 w-[215px] relative rounded-mini box-border hidden border-[1px] border-solid border-black" />
                  <h3 className="m-0 relative text-inherit font-normal font-inherit inline-block min-w-[16px] z-[1] mq450:text-lg">
                    +
                  </h3>
                  <div className="flex flex-col items-start justify-start pt-[2.5px] px-0 pb-0 text-xl">
                    <div className="relative inline-block min-w-[96px] z-[1] mq450:text-base">
                      Compare
                    </div>
                  </div>
                </div>
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[40px] max-w-full text-base text-darkgray mq750:gap-[20px]">
          ...
          <div className="flex flex-row items-start justify-start gap-[14px]">
            <div className="flex flex-col items-start justify-start gap-[12.7px]">
              <div className="relative inline-block min-w-[30px] z-[1]">
                SKU
              </div>
            ...
            <div className="flex flex-col items-start justify-start gap-[12px]">
              <div className="relative font-medium inline-block min-w-[4px] z-[1]">
                :
              </div>
              <div className="relative font-medium inline-block min-w-[4px] z-[1]">
                :
            ...
            <div className="flex flex-col items-start justify-start gap-[12.7px]">
              ...
              <div className="flex flex-row items-start justify-start gap-[24px]">
                ...
                <img
                  className="h-[25px] w-[25px] relative overflow-hidden shrink-0 min-h-[25px] z-[1]"
                  loading="lazy"
                  alt=""
